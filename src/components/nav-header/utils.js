export async function fetchBookmarksAsync(id, contentid) {
  ...
  try {
    const response = await fetch(
      'https://quranlive-api.herokuapp.com/fetchbookmarks',
      {
...
export async function fetchNotesAsync(id, contentid, page) {
  try {
    const response = await fetch(
      'https://quranlive-api.herokuapp.com/fetchnotes',
      {
...
export async function fetchAllNotesAsync(id, contentid) {
  try {
    const response = await fetch(
      'https://quranlive-api.herokuapp.com/fetchallnotes',
      {
...
export const deleteBookmarkAsync = async bookmarkid => {
  ...
  try {
    ...
    const response = await fetch(
      'https://quranlive-api.herokuapp.com/deletebookmark',
      {
        method: 'post',
        headers: {'Content-Type': 'application/json'},
        body: JSON.stringify({
...
export const deleteNoteAsync = async noteid => {
  ...
  try {
    const response = await fetch(
      'https://quranlive-api.herokuapp.com/deletenote',
      {
