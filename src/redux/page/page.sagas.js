...
import {
    setCopiesSuccess, setCopiesFailed, fetchCopiesSuccess, fetchCopiesFailed, updateCopySuccess, updateCopyFailure, setBookmarkSuccess, setBookmarkFailure, setNoteSuccess,setNoteFailure, fetchBookmarksSuccess, fetchBookmarksFailed} from './page.actions';
...
export function* updateCopyAsync({
  payload: {  id,page },
}) {
